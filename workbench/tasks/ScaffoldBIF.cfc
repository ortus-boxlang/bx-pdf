...
component {
	...
	function init(){
		...
		variables.util
			.addMapping( '/bifsDirectory',	"#variables.root#/src/main/java/ortus/boxlang/modules/pdf/bifs" )
			.addMapping( '/bifTestsDirectory', "#variables.root#/src/test/java/ortus/boxlang/modules/pdf/bifs" );
	...
	function run(
		...
		if( listLen( package, "." ) == 1 ){
			arguments.package = "ortus.boxlang.modules.pdf.bifs." & package;
